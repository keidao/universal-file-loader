...
import com.nostra13.universalfileloader.core.assist.FailReason.FailType;
import com.nostra13.universalfileloader.core.decode.ImageDecoder;
import com.nostra13.universalfileloader.core.decode.ImageDecodingInfo;
import com.nostra13.universalfileloader.core.download.ImageDownloader;
import com.nostra13.universalfileloader.core.download.ImageDownloader.Scheme;
 ...
 * display it in {@link com.nostra13.universalfileloader.core.imageaware.ImageAware} using {@link DisplayBitmapTask}.
 *
 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
 * @see FileLoaderConfiguration
 * @see FileLoadingInfo
 * @since 1.3.1
 */
final class LoadAndDisplayImageTask implements Runnable, IoUtils.CopyListener {
	...
	public LoadAndDisplayImageTask(FileLoaderEngine engine, FileLoadingInfo imageLoadingInfo, Handler handler) {
		this.engine = engine;
	...
	private byte[] tryLoadBitmap() throws TaskCancelledException {
	...
	private byte[] decodeImage(String imageUri) throws IOException {
		ImageDecodingInfo decodingInfo = new ImageDecodingInfo(memoryCacheKey, imageUri, getDownloader(), options);
