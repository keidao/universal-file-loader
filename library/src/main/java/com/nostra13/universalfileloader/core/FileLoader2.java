...
public class FileLoader2 {
	...
	public static final String TAG = FileLoader2.class.getSimpleName();
	...
	private volatile static FileLoader2 instance;

	/** Returns singleton class instance */
	public static FileLoader2 getInstance() {
		if (instance == null) {
			synchronized (FileLoader2.class) {
				if (instance == null) {
					instance = new FileLoader2();
				}
			}
		}
		return instance;
