...
import com.nostra13.universalfileloader.core.display.BitmapDisplayer;
import com.nostra13.universalfileloader.core.display.SimpleBitmapDisplayer;
 ...
 * <ul>
 * <li>whether stub image will be displayed in {@link com.nostra13.universalfileloader.core.imageaware.ImageAware
 ...
 * <li>whether {@link com.nostra13.universalfileloader.core.imageaware.ImageAware image aware view} should be reset
 ...
 * <b>i.e.</b> :
 * <code>new {@link DisplayFileOptions}.{@link Builder#Builder() Builder()}.{@link Builder#cacheInMemory() cacheInMemory()}.
...
public final class DisplayFileOptions {
	...
	private DisplayFileOptions(Builder builder) {
	...
	/**
	 * Builder for {@link DisplayFileOptions}
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 */
	public static class Builder {
		 ...
		 * {@link com.nostra13.universalfileloader.core.imageaware.ImageAware image aware view} but
		...
		public Builder cloneFrom(DisplayFileOptions options) {
		...
		/** Builds configured {@link DisplayFileOptions} object */
		public DisplayFileOptions build() {
			return new DisplayFileOptions(this);
		}
	}
	 ...
	 */
	public static DisplayFileOptions createSimple() {
