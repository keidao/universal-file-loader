...
import com.nostra13.universalfileloader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.nostra13.universalfileloader.core.assist.QueueProcessingType;
import com.nostra13.universalfileloader.core.decode.ImageDecoder;
import com.nostra13.universalfileloader.core.download.ImageDownloader;
import com.nostra13.universalfileloader.core.download.NetworkDeniedImageDownloader;
import com.nostra13.universalfileloader.core.download.SlowNetworkImageDownloader;
import com.nostra13.universalfileloader.core.process.BitmapProcessor;
...
public final class FileLoaderConfiguration {
	...
	final MemoryCacheAware<String, byte[]> memoryCache;
	final DiscCacheAware discCache;
	final ImageDownloader downloader;
	final ImageDecoder decoder;
	final DisplayFileOptions defaultDisplayImageOptions;
	 ...
	 * <li>defaultDisplayImageOptions = {@link DisplayFileOptions#createSimple() Simple options}</li>
	...
	public static class Builder {
		...
		private MemoryCacheAware<String, byte[]> memoryCache = null;
		private DiscCacheAware discCache = null;
		private FileNameGenerator discCacheFileNameGenerator = null;
		private ImageDownloader downloader = null;
		private ImageDecoder decoder;
		private DisplayFileOptions defaultDisplayImageOptions = null;
		 ...
		 * {@link com.nostra13.universalfileloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.nostra13.universalfileloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * </ul>
		 */
		public Builder memoryCache(MemoryCacheAware<String, byte[]> memoryCache) {
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.nostra13.universalfileloader.cache.disc.impl.TotalSizeLimitedDiscCache TotalSizeLimitedDiscCache}
		 ...
		 * By default: disc cache is unlimited.<br />
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.nostra13.universalfileloader.cache.disc.impl.FileCountLimitedDiscCache FileCountLimitedDiscCache}
		 * will be used as disc cache. You can use {@link #discCache(DiscCacheAware)} method for introduction your own
		 * implementation of {@link DiscCacheAware}
		 */
		 ...
		 * Default value -
		 * {@link com.nostra13.universalfileloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		 ...
		 * Default value -
		 * {@link com.nostra13.universalfileloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.nostra13.universalfileloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Default value - {@link com.nostra13.universalfileloader.cache.disc.impl.UnlimitedDiscCache
		 * UnlimitedDiscCache}. Cache directory is defined by
		 * {@link com.nostra13.universalfileloader.utils.StorageUtils#getCacheDirectory(Context)
		...
		/**
		 * Sets default {@linkplain DisplayFileOptions display image options} for image displaying. These options will
		 * be used for every {@linkplain FileLoader#displayImage(String, android.widget.ImageView) image display call}
		 * without passing custom {@linkplain DisplayFileOptions options}<br />
		 * Default value - {@link DisplayFileOptions#createSimple() Simple options}
		 */
		public Builder defaultDisplayImageOptions(DisplayFileOptions defaultDisplayImageOptions) {
		 ...
		 * Consider {@link com.nostra13.universalfileloader.utils.L#disableLogging()} to disable ImageLoader logging completely (even error logs)
		 */
		...
		private void initEmptyFieldsWithDefaultValues() {
			...
			if (denyCacheImageMultipleSizesInMemory) {
				memoryCache = new FuzzyKeyMemoryCache<String, byte[]>(memoryCache, MemoryCacheUtils
			...
			if (defaultDisplayImageOptions == null) {
				defaultDisplayImageOptions = DisplayFileOptions.createSimple();
			}
		}
	}
}
