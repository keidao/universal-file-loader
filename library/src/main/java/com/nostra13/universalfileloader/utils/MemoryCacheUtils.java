 ...
 *******************************************************************************/
package com.nostra13.universalfileloader.utils;
...
public final class MemoryCacheUtils {
	 ...
	 * {@link FileLoaderConfiguration.Builder#denyCacheImageMultipleSizesInMemory()
	 * denyCacheImageMultipleSizesInMemory()} option in {@linkplain FileLoaderConfiguration configuration}
	 */
	public static List<byte[]> findCachedBitmapsForImageUri(String imageUri, MemoryCacheAware<String, byte[]> memoryCache) {
